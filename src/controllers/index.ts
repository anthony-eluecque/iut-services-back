...
export { getUsers, getUser, createUser, login, authenticate, logout, deleteUser } from "./users.controller";
...
export { createService, getServices, getServiceById, updateService, deleteServiceById } from "./services.controller";